...
class ReportController extends BeehiveController{
  ...
  public function leiden($compilationVolume = 13): Response {
    ...
    return $this->render('report/leiden.html.twig', ['compilation' => $compilation, 'corrections' => $corrections]);
  }

  public function overview($compilationVolume = 13): Response {
    return $this->render('report/overview.html.twig', $this->getData($compilationVolume));
  }

  public function print($compilationVolume = 13, $editionId): Response {
    return $this->render('report/print.html.twig', $this->getData($compilationVolume, $editionId));
  }

  public function pdf($compilationVolume = 13, $editionId): Response {
