...
<!--
    java -Xms512m -Xmx1536m net.sf.saxon.Transform -o:postscript/pages.html -s:postscript/content_final.xml -xsl:exportPagesToHtml.xsl
-->
    ...
    <xsl:template match="/office:document-content">
        <html lang="en">
            <head>
                ...
                <title>BL pages for bibliography</title>
                <style>
            ...
            <body>
                <table>
                    ...
                    <tr class="{if($page mod 2)then('odd')else('even')}">
